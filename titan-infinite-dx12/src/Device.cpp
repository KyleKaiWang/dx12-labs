...
Device::Device(DXGI_FORMAT backBufferFormat, DXGI_FORMAT depthBufferFormat, UINT backBufferCount, D3D_FEATURE_LEVEL minFeatureLevel, UINT flags, UINT adapterIDoverride) :
    m_backBufferIndex(0),
    m_fenceValues{},
...
void Device::InitializeDXGIAdapter()
{
...
bool Device::WindowSizeChanged(int width, int height, bool minimized)
{
...
void Device::Prepare(D3D12_RESOURCE_STATES beforeState)
{
...
void Device::Present(D3D12_RESOURCE_STATES beforeState)
{
...
void Device::InitializeAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
